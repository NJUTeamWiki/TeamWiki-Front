    ...
    render(){
        ...
        return(
            <Col span={6} className="card" >        
             ...
             {content.uploader==userdata.userId?<Row className="delete" onClick={this.delete} ><Icon type="delete" theme="filled" /></Row>:""}
              ...
              <a href={`${serverIP}/storage/${content.url}`} download="file">
